...
// TODO: requires flask_predict.py hosted on localhost:5000
//TODO: plot predict: plot the LEARNED data set (1d, 2d, 3d) and plot the point being queried in a dif color- get this script from Jon + add point
...
function runScript(){
	...
	if (document.getElementById("select-predict").checked && document.getElementById("select-optimise").checked) {
		...
		if (document.getElementById('optimise-output-checkbox').checked){
			argument_string += 'y&' 
			alert('optimise output to file not yet implemented!')
		}
		else {
			argument_string += 'n&'
		}
